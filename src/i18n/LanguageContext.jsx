...
const resources = {
  en: {
    ...
    pre: {
      ...
      p2: 'Machines took over—faster, cheaper, and with infinite patience. They endured the endless feedback loops, delivered five “final versions” in a row, never sighed, never argued… and never ran out of office coffee.',
      p3: 'In his memory, the machines raised a digital mausoleum—built from broken memories, lost files, and the silence of a world that no longer needed human hands to create.\n\nInside this mausoleum, we can still access his memories, his works, and even the bugs provoked by the intrusive thoughts that once corrupted Skulley Rad’s mind... like another subscription no one remembers canceling.',
      enter: 'Enter',
  ...
  es: {
    ...
    pre: {
      ...
      p1: 'Skulley Rad fue el último diseñador gráfico de la humanidad. Murió de una enfermedad propia de nuestro siglo: volverse innecesario.',
      p2: 'Las máquinas tomaron el control—más rápidas, más baratas y con paciencia infinita. Soportaron los bucles eternos de feedback, entregaron cinco “versiones finales” seguidas, nunca suspiraron, nunca discutieron… y jamás se les acabó el café de oficina.',
      p3: 'En su memoria, las máquinas levantaron un mausoleo digital—construido con recuerdos rotos, archivos perdidos y el silencio de un mundo que ya no necesitaba manos humanas para crear.\n\nDentro de este mausoleo aún podemos acceder a sus recuerdos, a sus obras, e incluso a los bugs provocados por los pensamientos intrusivos que alguna vez corrompieron la mente de Skulley Rad… como otra suscripción que nadie recuerda cancelar.',
      enter: 'Entrar',
