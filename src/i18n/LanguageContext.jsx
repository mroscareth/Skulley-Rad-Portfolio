...
const resources = {
  en: {
    ...
    customizer: {
      ...
      title: 'Customize',
      hint: 'Repaint Skulley. Changes apply everywhere instantly.',
      eyes: 'Eyes',
      skeleton: 'Skeleton',
      hair: 'Hair',
      orb: 'Orb',
    ...
    spheresTutorial: {
      ...
      howToPlay: 'Walk into the colored spheres to push them toward the portals. Hold SPACE to charge a kick, or hold E for a power blast that sends them flying!',
      scoring: 'Scoring',
    ...
    zoidian: {
      dialogAria: 'Argus dialog',
      title: 'Argus',
      subtitle: 'keeper of the spheres',
      line1: "No clue where these weird spheres came from... but sprinkle a little salt on them and they taste delicious!",
      line2: "Here's the deal: shove as many spheres as you can into the portals to teleport them to my hou— um... into the void. In exchange, I'll talk to M.A.D.R.E. about getting you some discounts for the store.",
      question: 'Deal?',
      play: "Let's play",
      notNow: 'Not now',
      mock: 'Hehehe, fool.',
      // Empujón por invadirle el espacio (distinto del rayo: acá el tema es
      // la distancia personal, no la desgracia ajena).
      mockPush: [
        'Hey, respect my personal space!',
        'Covid taught us about social distancing...',
        'Hugs cost extra!',
        'Walk it off!',
        'Before touching, at least buy me dinner first',
        'Easy there, we’re not that close!',
      ],
      mockEgg: [
        'Walk it off!',
        'Heads up! ...too late.',
        'Somebody get him a Tylenol!',
        'Hope you have insurance...',
        'Smells like barbecue!',
        'Anyone catch that lightning’s plates?',
      ],
    },
    game: {
      endGame: 'END GAME',
    ...
    tutorial: {
      ...
      welcome: {
        title: 'Welcome',
        desc: "Welcome to the archive. Move the character, explore the scene and step into the glowing portals to open each section of Oscar's work.",
        hint: 'You can replay this guide anytime from the menu.',
      },
      move: {
        title: 'Movement',
        desc: 'Move your character around the scene.',
        desktop: 'WASD or arrow keys',
        mobile: 'Drag the joystick (bottom-left)',
      },
      power: {
        title: 'Power',
        desc: 'Charge power and release to push the orbs into the portals.',
        desktop: 'Hold E',
        mobile: 'Hold the bolt button (bottom-right)',
        power: 'Power',
      ...
      camera: {
        ...
        mobile: 'One finger to rotate · pinch to zoom',
        hint: 'Enter the glowing portals to switch sections.',
  ...
  es: {
    ...
    customizer: {
      open: 'Personalizar personaje',
      title: 'Personalizar',
      hint: 'Repinta a Skulley. Los cambios se aplican al instante en todo el sitio.',
      eyes: 'Ojos',
      skeleton: 'Esqueleto',
      hair: 'Pelo',
      orb: 'Esfera',
    ...
    spheresTutorial: {
      ...
      howToPlay: 'Camina contra las esferas de colores para empujarlas hacia los portales. ¡Mantén ESPACIO para cargar una patada, o mantén E para un golpe de poder que las manda volando!',
      scoring: 'Puntuación',
    ...
    zoidian: {
      dialogAria: 'Diálogo de Argus',
      title: 'Argus',
      subtitle: 'guardián de las esferas',
      line1: 'No tengo idea de dónde salieron estas esferas tan raras... ¡pero si les pones un poco de sal saben deliciosas!',
      line2: 'Te propongo algo: mete tantas esferas como puedas en los portales para teletransportarlas a mi cas— em... al vacío. Y a cambio, hablaré con M.A.D.R.E. para que te dé algunos descuentos en la tienda.',
      question: '¿Vale?',
      play: 'Vamos a jugar',
      notNow: 'Ahora no',
      mock: 'Jejeje, bobo.',
      ...
      // la distancia personal, no la desgracia ajena).
      mockPush: [
        '¡Hey, respeta mi espacio!',
        'El Covid nos enseñó la sana distancia...',
        '¡Los abrazos son cobrados!',
        '¡Sóbate!',
        'Antes de tocar, invítame primero al cine',
        '¡Ubícate, no somos tan amigos!',
      ],
      mockEgg: [
        '¡Sóbate!',
        '¡Golpe avisa!',
        '¡Dénle un paracetamol!',
        'Espero que tengas seguro...',
        '¡Huele a rostizado!',
        '¿Alguien le vio la placa al rayo?',
      ],
    },
    game: {
    ...
    tutorial: {
      ...
      welcome: {
        title: 'Bienvenido',
        desc: 'Bienvenido al archivo. Mueve al personaje, explora el escenario y entra a los portales brillantes para abrir cada sección del trabajo de Oscar.',
        hint: 'Puedes volver a ver esta guía cuando quieras desde el menú.',
      },
      move: {
        title: 'Movimiento',
        desc: 'Mueve a tu personaje por el escenario.',
        desktop: 'WASD o las flechas del teclado',
        mobile: 'Arrastra el joystick (abajo a la izquierda)',
      },
      power: {
        title: 'Poder',
        desc: 'Carga poder y suéltalo para empujar las esferas hacia los portales.',
        desktop: 'Mantén E',
      ...
      camera: {
        ...
        desc: 'Mira alrededor y encuentra los portales entre secciones.',
        desktop: 'Arrastra para rotar · scroll para zoom',
        mobile: 'Un dedo para rotar · pellizca para zoom',
        hint: 'Entra a los portales brillantes para cambiar de sección.',
        switch: 'Cambiar vista de cámara',
      },
    },
  },
}
