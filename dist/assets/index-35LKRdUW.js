const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Section2-BIIrODKV.js","assets/vendor-CB-xz4Zg.js","assets/Section3-Cvo4to9R.js","assets/Section4-Cv3qKl96.js"])))=>i.map(i=>d[i]);
import { u as useThree, r as reactExports, C as Color, a as jsxRuntimeExports, E as Environment$1, M as MeshReflectorMaterial, b as useGLTF, c as useAnimations, V as Vector3, R as React, B as Box3, L as LoopRepeat, d as useFrame, e as MathUtils, f as BufferAttribute, A as AdditiveBlending, K as KTX2Loader, Q as Quaternion, g as Euler, O as OrbitControls, s as shaderMaterial, h as extend, i as gsapWithCSS, F as ForwardRef, k as Canvas, l as dt, m as Rt, n as BlendFunction, y as yt, U as Ut, G as GlitchMode, o as clone, p as Raycaster, P as Plane, q as Matrix4, t as Lt, w as wt, X as Xt, T as ToneMappingMode, v as ce, x as qt, z as Ct, D as At, H as FrontSide, I as ForwardRef$1, J as ForwardRef$2, N as ForwardRef$3, S as ForwardRef$4, W as ForwardRef$5, _ as __vitePreload, Y as Frustum, Z as Sphere, $ as PCFSoftShadowMap, a0 as AdaptiveDpr, a1 as ForwardRef$6, a2 as ReactDOM } from "./vendor-CB-xz4Zg.js";
(function polyfill() {
...
function Environment({ overrideColor, lowPerf = false }) {
...
function Player({ playerRef, portals = [], onPortalEnter, onProximityChange, onPortalsProximityChange, onNearPortalChange, navigateToPortalId = null, onReachedPortal, onOrbStateChange, onHomeSplash, sceneColor }) {
  const { gl } = useThree();
  ...
  useFrame((state, delta) => {
    ...
    if (orbActiveRef.current && fadeOutTRef.current < 1) {
      fadeOutTRef.current = Math.min(1, fadeOutTRef.current + dt2 / FADE_OUT);
...
function CharacterPortrait({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: containerRef, className: "fixed left-10 bottom-10 flex gap-3 items-end", style: { zIndex }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { width: "12rem", height: "18rem" }, children: [
...
function Section1$1({ scrollerRef, scrollbarOffsetRight = 0 }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pointer-events-auto select-none relative", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-[0] pointer-events-none", "aria-hidden": true, style: { right: `${scrollbarOffsetRight}px` }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Canvas,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Environment$1, { files: `${"/development/"}light.hdr`, background: false }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ambientLight", { intensity: 0.8 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("directionalLight", { intensity: 0.6, position: [0, 0, 10] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ParallaxBirds, { scrollerRef })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-[12010] space-y-12 w-full min-h-screen flex flex-col items-center justify-start", children: items.map((it) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { item: it, onEnter, onMove, onLeave }) }, it.id)) }),
...
function ParallaxBirds({ scrollerRef }) {
  ...
  useFrame((_, delta) => {
    ...
    const dt2 = Math.max(1e-3, delta);
    const vel = (top - (prevTopRef.current || 0)) / dt2;
    prevTopRef.current = top;
    const tL = clamp01((tRaw - 0) / 1);
    const tR = clamp01((tRaw - 0.25) / 0.75);
    const baseL = 0.33, rangeL = 0.36;
    const baseR = 0.86, rangeR = 0.32;
    const oscL = Math.sin(tL * Math.PI * 2 * 1.1) * 0.1;
    const oscR = Math.sin(tR * Math.PI * 2 * 0.8 + Math.PI * 0.35) * 0.08;
    ...
    if (!initRef.current) {
      leftYRef.current = yLscreenTarget;
      leftVyRef.current = 0;
      rightYRef.current = Math.min(viewportH * 0.94, yRscreenTarget + viewportH * 0.08);
      rightVyRef.current = 0;
      leftXRef.current = layout.left.x - size.width / 2;
      leftVxRef.current = 0;
      rightXRef.current = layout.right.x - size.width / 2;
      rightVxRef.current = 0;
    ...
    } else {
      {
        ...
        const minY = viewportH * 0.1, maxY = viewportH * 0.9;
    ...
    {
      const time = (typeof performance !== "undefined" ? performance.now() : Date.now()) / 1e3;
      {
        ...
        const minKickX = 60;
        if (xNext < minX) {
          const over = minX - xNext;
          xNext = minX + over;
          vxNext = Math.max(Math.abs(vxNext) * bounceX + 0.25 * Math.abs(vx), minKickX);
        } else if (xNext > maxX) {
          const over = xNext - maxX;
          xNext = maxX - over;
          vxNext = -Math.max(Math.abs(vxNext) * bounceX + 0.25 * Math.abs(vx), minKickX);
        }
      ...
      }
      {
        ...
        const kx = 7, cx = 3.9;
        const minX = -size.width / 2 + Math.min(size.width, size.height) * 0.2;
        const maxX = size.width / 2 - Math.min(size.width, size.height) * 0.2;
        ...
        if (xNext < minX) {
          const over = minX - xNext;
          xNext = minX + over;
          vxNext = Math.max(Math.abs(vxNext) * bounceX + 0.28 * Math.abs(vx), minKickX);
        } else if (xNext > maxX) {
          const over = xNext - maxX;
          xNext = maxX - over;
          vxNext = -Math.max(Math.abs(vxNext) * bounceX + 0.28 * Math.abs(vx), minKickX);
    ...
    if (leftRef.current) {
      ...
      leftRef.current.rotation.x += delta * (0.02 + 0.012 * Math.cos(tL * PI2 * 0.7) + entryBoost * 0.5);
      leftRef.current.rotation.z += delta * (0.026 + 1e-4 * vel) + -leftVyRef.current * 35e-6 + entryBoost * 0.4;
    }
    if (rightRef.current) {
      const x = rightXRef.current;
      let y = viewportH / 2 - rightYRef.current;
      const ENTRY_MS = 900;
      const now = typeof performance !== "undefined" ? performance.now() : Date.now();
      if (entryStartRef.current == null) entryStartRef.current = now;
      const p = Math.max(0, Math.min(1, (now - entryStartRef.current) / ENTRY_MS));
      if (p < 1) {
        const off = viewportH * 0.4;
        const eased = easeOutBack(p);
        y -= (1 - eased) * off;
      }
      {
      ...
      rightRef.current.rotation.y -= delta * (0.05 + 0.022 * Math.cos(tR * PI2 * 0.9) + entryBoostR);
      rightRef.current.rotation.x -= delta * (0.018 + 0.01 * Math.sin(tR * PI2 * 1.2) + entryBoostR * 0.5);
      rightRef.current.rotation.z -= delta * (0.022 + 8e-5 * vel) + -rightVyRef.current * 32e-6 + entryBoostR * 0.35;
    }
...
function FollowLight({ playerRef, height = 6, intensity = 2.5, color = "#ffffff", angle = 0.8, penumbra = 0.6 }) {
...
function MusicPlayer({ tracks = [], navHeight }) {
  ...
  const resolveUrl2 = (path) => {
    if (!path) return null;
    try {
      return encodeURI(new URL(path.replace(/^\/+/, ""), "/development/").href);
    } catch {
      return path;
    }
  };
  ...
  async function loadTrack(urlIn, opts = { activate: true }) {
    ...
    const url = (() => {
      try {
        return new URL(urlIn.replace(/^\/+/, ""), "/development/").href;
      } catch {
        return urlIn;
      }
    })();
  ...
  reactExports.useEffect(() => {
    ...
    (async () => {
      ...
      const fullUrl = (() => {
        try {
          return new URL(url.replace(/^\/+/, ""), "/development/").href;
        } catch {
          return url;
        }
      })();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: containerRef, className: "music-pill pointer-events-auto relative bg-white/95 backdrop-blur rounded-full shadow-lg flex items-center gap-2 max-w-[92vw] select-none text-black", style: { height: `${heightPx}px`, padding: `${verticalPadding}px`, width: "420px", overflow: "visible" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "disc-wrap shrink-0 relative select-none origin-left", style: { width: `${discSize}px`, height: `${discSize}px` }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0", style: { cursor: isDraggingRef.current ? "grabbing" : "grab" }, onPointerDown: onDown, onPointerMove: onMove, onPointerUp: onUp, onPointerCancel: onUp })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pill-content right-ui flex-1 min-w-0", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "p-2 rounded-full hover:bg-black/10 disabled:opacity-40", onClick: () => {
        if (!hasTracks) return;
        if (switchingRef.current) return;
        stoppingRef.current = true;
        pauseWA();
        ...
        setIsPlaying(true);
      }, disabled: !hasTracks, "aria-label": "Previous", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$2, { className: "w-5 h-5" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "p-2 rounded-full hover:bg-black/10 disabled:opacity-50", onClick: () => setIsPlaying((v) => !v), disabled: !hasTracks, "aria-label": isPlaying ? "Pause" : "Play", children: isPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$3, { className: "w-6 h-6" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$4, { className: "w-6 h-6" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "p-2 rounded-full hover:bg-black/10 disabled:opacity-40", onClick: () => {
        if (!hasTracks) return;
        if (switchingRef.current) return;
        stoppingRef.current = true;
        ...
        setIndex((i) => (i + 1) % tracks.length);
        setIsPlaying(true);
      }, disabled: !hasTracks, "aria-label": "Next", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$5, { className: "w-5 h-5" }) })
    ] }),
    ...
    (async () => {
      try {
        ...
        const { default: jsmediatags } = await __vitePreload(async () => {
          const { default: jsmediatags2 } = await import("./vendor-CB-xz4Zg.js").then((n) => n.j);
...
const Section2 = reactExports.lazy(() => __vitePreload(() => import("./Section2-BIIrODKV.js"), true ? __vite__mapDeps([0,1]) : void 0));
const Section3 = reactExports.lazy(() => __vitePreload(() => import("./Section3-Cvo4to9R.js"), true ? __vite__mapDeps([2,1]) : void 0));
const Section4 = reactExports.lazy(() => __vitePreload(() => import("./Section4-Cv3qKl96.js"), true ? __vite__mapDeps([3,1]) : void 0));
const sectionColors = {
  home: "#0f172a",
  section1: "#00bfff",
  // Work
...
function App() {
  ...
  const [showMusic, setShowMusic] = reactExports.useState(true);
  ...
  React.useEffect(() => {
    ...
    const preload = () => {
      ...
      try {
        __vitePreload(() => import("./Section2-BIIrODKV.js"), true ? __vite__mapDeps([0,1]) : void 0);
      } catch {
      }
      try {
        __vitePreload(() => import("./Section3-Cvo4to9R.js"), true ? __vite__mapDeps([2,1]) : void 0);
      } catch {
      }
      try {
        __vitePreload(() => import("./Section4-Cv3qKl96.js"), true ? __vite__mapDeps([3,1]) : void 0);
      } catch {
      }
    };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full h-full relative overflow-hidden", children: [
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "pointer-events-auto fixed right-6 top-1/2 -translate-y-1/2 z-[12020] hidden sm:flex flex-col items-center gap-2 select-none",
              onWheel: (e) => {
                try {
              ...
              "aria-hidden": true,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "w-2 h-2 rounded-full bg-white/30", onClick: () => sectionScrollRef.current?.scrollBy({ top: -window.innerHeight * 0.6, behavior: "smooth" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1.5 h-28 rounded-full bg-white/15 relative overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-0 right-0 rounded-full bg-white/60", style: { top: `${(28 - 12) * sectionScrollProgress}px`, height: "12px" } }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "w-2 h-2 rounded-full bg-white/30", onClick: () => sectionScrollRef.current?.scrollBy({ top: window.innerHeight * 0.6, behavior: "smooth" }) })
              ]
            }
          )
            ...
            onClick: async () => {
              ...
              try {
                const preloadMap = {
                  ...
                  section2: () => __vitePreload(() => import("./Section2-BIIrODKV.js"), true ? __vite__mapDeps([0,1]) : void 0),
                  section3: () => __vitePreload(() => import("./Section3-Cvo4to9R.js"), true ? __vite__mapDeps([2,1]) : void 0),
                  section4: () => __vitePreload(() => import("./Section4-Cv3qKl96.js"), true ? __vite__mapDeps([3,1]) : void 0)
                };
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: navRef, className: "pointer-events-auto fixed inset-x-0 bottom-10 z-[450] flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: navInnerRef, className: "relative bg-white/95 backdrop-blur rounded-full shadow-lg p-2.5 flex items-center gap-0 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(MusicPlayer, { tracks, navHeight })
      }
    ),
