const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Section1-BRijEIrj.js","assets/vendor-BrMlHQeX.js","assets/Section2-BX9aB2-m.js","assets/Section3-D00g2ke4.js","assets/Section4-Br2VuuwX.js"])))=>i.map(i=>d[i]);
import { u as useThree, r as reactExports, C as Color, a as jsxRuntimeExports, E as Environment$1, M as MeshReflectorMaterial, b as useGLTF, c as useAnimations, V as Vector3, R as React, B as Box3, L as LoopRepeat, d as useFrame, e as BufferAttribute, A as AdditiveBlending, f as MathUtils, K as KTX2Loader, Q as Quaternion, g as Euler, O as OrbitControls, s as shaderMaterial, h as extend, i as gsapWithCSS, k as Canvas, l as dt, m as Rt, n as BlendFunction, y as yt, U as Ut, G as GlitchMode, o as clone, p as Lt, w as wt, X as Xt, T as ToneMappingMode, q as ce, t as qt, v as Ct, x as At, F as ForwardRef, z as ForwardRef$1, D as ForwardRef$2, H as ForwardRef$3, _ as __vitePreload, I as Frustum, J as Matrix4, S as Sphere, P as PCFSoftShadowMap, N as AdaptiveDpr, W as ForwardRef$4, Y as ReactDOM } from "./vendor-BrMlHQeX.js";
(function polyfill() {
...
function Player({ playerRef, portals = [], onPortalEnter, onProximityChange, onPortalsProximityChange, onNearPortalChange, navigateToPortalId = null, onReachedPortal, onOrbStateChange, sceneColor }) {
  const { gl } = useThree();
  ...
  const TrailSparks = () => {
    ...
    reactExports.useEffect(() => {
      ...
      geoRef.current.setAttribute("position", new BufferAttribute(positionsRef.current, 3));
...
function CharacterPortrait({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: containerRef, className: "fixed left-10 bottom-10 flex gap-3 items-end", children: [
    showBubble && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative font-semibold tracking-wide px-2 text-center uppercase text-[14px] sm:text-[15px]", style: { fontFamily: '"Comic Neue", system-ui, -apple-system, Segoe UI, Roboto, Arial, sans-serif' }, children: bubbleText }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
...
function MusicPlayer({ tracks = [] }) {
  ...
  reactExports.useEffect(() => {
    ...
    const src = (() => {
      try {
        return encodeURI(new URL(current.src.replace(/^\/+/, ""), "/development/").href);
      } catch {
        return current.src;
      }
    })();
  ...
  const containerRef = reactExports.useRef(null);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: containerRef, className: "pointer-events-auto w-[360px] max-w-[92vw] rounded-2xl overflow-hidden text-white shadow-xl select-none bg-black/50 backdrop-blur rgb-border rgb-glow", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[4/3] bg-white/5 rounded-b-none", children: [
      current?.cover ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: current.cover, alt: "cover", className: "absolute inset-0 w-full h-full object-cover rounded-t-2xl" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CoverFromMeta, { src: current?.src, className: "absolute inset-0 w-full h-full object-cover rounded-t-2xl" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-x-0 bottom-0 p-3 bg-gradient-to-t from-black/80 via-black/40 to-transparent", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: Array.from({ length: 4 }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "mx-6", children: [
            current?.title || "No tracks",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            disabled: !canPrev,
            "aria-label": "Previous",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef, { className: "w-7 h-7" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: isPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$1, { className: "w-9 h-9" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$2, { className: "w-9 h-9" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            disabled: !canNext,
            "aria-label": "Next",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$3, { className: "w-7 h-7" })
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-[11px] opacity-70 tabular-nums", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-marquee", children: formatTime(currentTime) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-marquee", children: formatTime(duration) })
        ] })
      ] })
    ] }),
...
function CoverFromMeta({ src, className }) {
    ...
    (async () => {
      try {
        ...
        const { default: jsmediatags } = await __vitePreload(async () => {
          const { default: jsmediatags2 } = await import("./vendor-BrMlHQeX.js").then((n) => n.j);
  ...
  if (dataUrl) return /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: dataUrl, alt: "cover", className: className || "w-16 h-16 rounded object-cover" });
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: className ? `${className} grid place-items-center` : "w-16 h-16 rounded bg-white/10 grid place-items-center text-xs opacity-80", children: "No Cover" });
}
...
const Section1 = reactExports.lazy(() => __vitePreload(() => import("./Section1-BRijEIrj.js"), true ? __vite__mapDeps([0,1]) : void 0));
const Section2 = reactExports.lazy(() => __vitePreload(() => import("./Section2-BX9aB2-m.js"), true ? __vite__mapDeps([2,1]) : void 0));
const Section3 = reactExports.lazy(() => __vitePreload(() => import("./Section3-D00g2ke4.js"), true ? __vite__mapDeps([3,1]) : void 0));
const Section4 = reactExports.lazy(() => __vitePreload(() => import("./Section4-Br2VuuwX.js"), true ? __vite__mapDeps([4,1]) : void 0));
const sectionColors = {
  home: "#0f172a",
  section1: "#00bfff",
  // Work
...
function App() {
  ...
  React.useEffect(() => {
    ...
    const preload = () => {
      try {
        __vitePreload(() => import("./Section1-BRijEIrj.js"), true ? __vite__mapDeps([0,1]) : void 0);
      } catch {
      }
      try {
        __vitePreload(() => import("./Section2-BX9aB2-m.js"), true ? __vite__mapDeps([2,1]) : void 0);
      } catch {
      }
      try {
        __vitePreload(() => import("./Section3-D00g2ke4.js"), true ? __vite__mapDeps([3,1]) : void 0);
      } catch {
      }
      try {
        __vitePreload(() => import("./Section4-Br2VuuwX.js"), true ? __vite__mapDeps([4,1]) : void 0);
      } catch {
      }
    };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full h-full relative overflow-hidden", children: [
    ...
    (showSectionUi || sectionUiAnimatingOut) && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky top-0 z-[10] flex items-center justify-end px-4 py-3 bg-black/20 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: null, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto p-6 sm:p-8", children: [
            section === "section1" && /* @__PURE__ */ jsxRuntimeExports.jsx(Section1, {}),
    ...
    !transitionState.active && (showCta || ctaAnimatingOut) && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: "Cruza el portal"
          }
        )
      }
    ),
    !transitionState.active && (showMarquee || marqueeAnimatingOut) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed top-0 left-0 right-0 z-[9999] pointer-events-none py-2", style: { animation: `${nearPortalId || showSectionBanner ? "slidedown 200ms ease-out" : "slidedown-out 200ms ease-in forwards"}` }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-black/55 to-transparent" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "whitespace-nowrap opacity-95 will-change-transform", style: { animation: "marquee 18s linear infinite" }, children: Array.from({ length: 6 }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "span",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(ForwardRef$4, { className: "w-5 h-5" })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-auto fixed inset-x-0 bottom-4 z-[450] flex items-center justify-center gap-3", children: ["section1", "section2", "section3", "section4"].map((id) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        onClick: () => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(MusicPlayer, { tracks })
      }
    ),
    showFxPanel && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pointer-events-auto fixed right-4 bottom-16 w-56 p-3 rounded-md bg-black/50 text-white space-y-2 select-none z-[500]", children: [
