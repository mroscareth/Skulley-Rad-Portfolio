import { R as React, a as jsxRuntimeExports } from "./vendor-DqNCmiEp.js";
import { u as useLanguage } from "./index-gtNS5M97.js";
function ContactForm() {
  ...
  if (submitted) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full mx-auto text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-marquee text-black uppercase leading-none text-[clamp(72px,14vw,240px)] inline-block mx-auto whitespace-nowrap", children: t("contact.thanks") || "THANK YOU!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-xl sm:text-2xl md:text-3xl text-black/90", children: t("contact.thanksDesc") || "He recibido tu mensaje, pronto estaré en contacto contigo." })
    ] });
  }
  const steps = [
