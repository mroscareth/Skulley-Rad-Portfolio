...
-- Every code = a discount %. `rarity` groups them for UI/analytics.
-- `action` is an optional cosmetic perk (e.g. goldSkin) granted alongside.
-- =============================================
...
-- Seed: goldeneggs — the legendary golden ticket.
-- Discount 50% + goldSkin perk. Unlimited uses (max_uses=0) for now.
INSERT INTO cheat_codes (code, discount_pct, rarity, label, action, max_uses)
VALUES ('goldeneggs', 50, 'legendary', 'Legendary Gold Skin', 'goldSkin', 0)
